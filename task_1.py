...
class TestAddNewBook:
    ...
    def test_add_new_book_with_valid_name(self, collector):
    ...
    def test_add_new_book_does_not_overwrite_existing(self, collector):
...
class TestSetBookGenre:
    ...
    def test_set_book_genre_negative_if_book_not_exist(self, collector):
...
class TestFavorites:
    ...
    def test_delete_book_from_favorites_removes_correctly(self, collector):
...
class TestGetBooksGenre:
    ...
    def test_get_books_genre_returns_full_mapping(self, collector):
        collector.add_new_book("Гарри Поттер")
